...
from clients.authentification.authentification_schema import LoginRequestSchema, RefreshRequestSchema, TokenSchema, LoginResponseSchema
...
# Добавляем builder для AuthentificationClient
def get_authentification_client() -> AuthentificationClient:
    """
    Функция создаёт экземпляр AuthentificationClient с уже настроенным HTTP-клиентом.

    :return: Готовый к использованию AuthentificationClient.
    """
